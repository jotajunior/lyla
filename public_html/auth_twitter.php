...
// we're being called back by Twitter
  ...
  if ($code == 200) {
    $_SESSION['access_token'] = $tmhOAuth->extract_params($tmhOAuth->response['response']); /* JOGAR ISSO NO BANCO, JUNTAR COM OUTROS ATRIBUTOS PARA VERIFICAR 2 TOKENS POR USUÁRIO, GUARDANDO NOME DA CONTA TAMBÉM. FAZER ISSO COM ORKUT E TWITTER, É LIGHT, SÓ ADICIONAR O CAMPO 'ITEM_UNICO', PARA DEFINIR O ITEM QUE É UNICO, O ID UNICO, DE CADA USUÁRIO CADASTRADO EM CADA REDE SOCIAL.*/
